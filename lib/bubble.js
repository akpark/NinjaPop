(function () {
  ...
  Bubble.prototype.move = function (timeDelta) {
    ...
    // hits the wall
    if (this.game && this.game.isOutOfBounds(this.x)) {
      this.vx *= -1;
    }
    ...
    if (this.y > NinjaPop.Game.DIM_Y - (this.radius * 2) - NinjaPop.Footer.HEIGHT) {
      switch (this.size) {
        case 5:
          this.vy = Bubble.ELASTICITY * -8;
          break;
        case 4:
          this.vy = Bubble.ELASTICITY * -7;
          break;
        case 3:
          this.vy = Bubble.ELASTICITY * -6;
          break;
        case 2:
          this.vy = Bubble.ELASTICITY * -5;
          break;
        case 1:
          this.vy = Bubble.ELASTICITY * -4;
          break;
      }
    }
  };
