(function () {
  ...
  var Bubble = NinjaPop.Bubble = function (bubbleParams) {
    ...
    this.sound = new Audio("assets/sounds/pop.wav");
  ...
  Bubble.prototype.draw = function (ctx) {
    if (this.comboShown) {
      ...
      ctx.font = "22px rockwell";
      ctx.fillText("COMBO!", this.x,  this.y+20);
    }
    this.ctx = ctx;
    ctx.drawImage(
      this.image,
  ...
  Bubble.prototype.move = function (timeDelta) {
    ...
    if (this.y > NinjaPop.Game.DIM_Y - (this.radius * 2) - NinjaPop.Footer.HEIGHT) {
      switch (this.size) {
        case 5:
          this.vy = Bubble.ELASTICITY * -6.5;
          break;
        case 4:
          this.vy = Bubble.ELASTICITY * -5.6;
          break;
        case 3:
          this.vy = Bubble.ELASTICITY * -5.1;
          break;
        case 2:
  ...
  Bubble.prototype.showCombo = function () {
    this.ctx.fillStyle = "#ff8533";
    this.ctx.font = "16px rockwell";
    this.ctx.fillText("COMBO!", this.x,  this.y+20);
  };
